...
const schema = z.object({
  ...
  member1: z.string().regex(/^[A-Za-z\s]+$/, "Only alphabets allowed"),
  enrollment1: z.string().regex(/^[0-9]+$/, "Numbers only"),
  year1: z.enum(["1st", "2nd", "3rd", "4th"]),
  email1: z.string().email("Invalid email"),
  phone1: z.string().regex(/^[0-9]{10}$/, "Phone must be 10 digits"),

  member2: z.string().regex(/^[A-Za-z\s]+$/, "Only alphabets allowed"),
  enrollment2: z.string().regex(/^[0-9]+$/, "Numbers only"),
  year2: z.enum(["1st", "2nd", "3rd", "4th"]),
  email2: z.string().email("Invalid email"),
  phone2: z.string().regex(/^[0-9]{10}$/, "Phone must be 10 digits"),
});
